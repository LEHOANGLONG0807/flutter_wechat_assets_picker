...
abstract class AssetPickerBuilderDelegate<Asset, Path> {
  ...
  SystemUiOverlayStyle get overlayStyle =>
      ...
      (theme.effectiveBrightness.isDark ? SystemUiOverlayStyle.light : SystemUiOverlayStyle.dark);
          ...
          child: Selector<DefaultAssetPickerProvider, String>(
            ...
            builder: (BuildContext c, __, ___) => Padding(
              ...
              child: ScaleText(
                ...
                style: TextStyle(
                  color: c.themeData.textTheme.bodySmall?.color,
                  fontSize: 17,
                ),
                maxScaleFactor: 1.2,
